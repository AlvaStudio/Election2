...
public class Constants {
    ...
    public static final String API_COMMAND_SEND_VOTE = "addvote.php";
    public static final String API_PARAM_VOTE_ID = "candidate_id";
    public static final String API_PARAM_LAST_VOTE_ID = "last_id";
